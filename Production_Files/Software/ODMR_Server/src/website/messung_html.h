#ifndef MESSUNG_HTML_H
#define MESSUNG_HTML_H

const char MESSUNG_HTML[] PROGMEM = R"====(
<!DOCTYPE HTML>
<html lang="de">
<head>
    <meta charset="UTF-8">
    ...
    <script> 
        ...
        const fMin=2200, fMax=3600, stepMin=0.2, stepMax=5; 
    ...
    <script> 
        async function MessungStarten(){ 
            ...
            addDataGroup(); 
            Messreihe=[];   
            if(AutoMessung){setTimeout(MessungStarten, 600);}
            else{ToggleStart(1);}  
        }
        function autoScale(){
        ...
        function AutoToggle(){
            ...
            if (AutoMessung){ Autobutton.value="Einzelmessung"; AutoMessung=0;}
            else{ Autobutton.value="Dauermessung";AutoMessung=1;}
        }
        function fReset(){
        ...
        function ToggleStart(OnOff){
            ...
            if(OnOff){StartButton.disabled=false;StartButton.value="Messung starten";}
            else{StartButton.disabled=true;StartButton.value="Messung läuft";}
        }
...
<body>
    ...
    <div class="grid-container">
        ...
        <div class="grid2" >
            <input type="button" class="Button Laserbutton" id="Laser"  value="Laserdiode einschalten">
        </div>
        <div class="grid3">
        ...
        <div class="grid4">
            <input type="button" class="Button StartButton" id="StartStop" value="Messung starten">
            <input type="button" class="Button Toggle"id="AutoMessung" value="Einzelmessung">   
        </div>
        ...
        <form>
            ...
            <div>
                <input type="button" class="Button setValue" id="fB-100" value="-100">
                <input type="button" class="Button setValue" id="fB-10" value="-10">
                <div class="inputField">
                    <label for="f_begin">Startfrequenz: </label>
                    <input type="number" name="Startfrequenz" id="f_begin" value=2820 min="2200" max="3600" step="0.1">
                </div>
                <input type="button" class="Button setValue" id="fB10" value="+10">
                <input type="button" class="Button setValue" id="fB100" value="+100">
            </div>
            
            <div>
                <input type="button" class="Button setValue" id="fE-100" value="-100">
                <input type="button" class="Button setValue" id="fE-10" value="-10">
                <div class="inputField">
                    <label for="f_end">Endfrequenz: </label>
                    <input type="number" name="Endfrequenz" id="f_end" value="2920" min="2200" max="3600" step="0.1">
                </div>
                <input type="button" class="Button setValue" id="fE10" value="+10">
                <input type="button" class="Button setValue" id="fE100" value="+100">
            </div>
            ...
            <div>
               ...
               <div class="inputField">
                    ...
                    <input type="number" name="Schrittgroesse" id="f_step" value="2.0"min="0.1" max="5" step="0.1">
                </div>
                <input type="button" class="Button setValue" id="fs1" value="+1">
                
            </div>
            <div> 
                <input type="button" class="Button setValue SaveData" id="sendData" disabled="true" value="Daten übernehmen">
                <input type="button" class="Button setValue SaveData" id="f_Reset" value="Daten zurücksetzen">
            </div>
            <div>
                <input type="button" class="Button" id="MessreiheHerunterladen" value="Messungen herunterladen">
                <input type="button" class="Button" id="Clear" value="Anzeige leeren">
            </div>
        ...
        <script>
            ...
            function YRangeContr2(_this){
                let IntensitätswertLogarithmisch=Math.min(100*Math.floor(Math.pow(2, _this.value)),36000);
                if((ById("YMid1").value-IntMin)*2<IntensitätswertLogarithmisch){ById("YMid1").value=IntMin+IntensitätswertLogarithmisch/2;ById("YMid2").value=IntMin+IntensitätswertLogarithmisch/2;}
                else if((IntMax-ById("YMid1").value)*2<IntensitätswertLogarithmisch){ById("YMid1").value=IntMax-IntensitätswertLogarithmisch/2;ById("YMid2").value=IntMax-IntensitätswertLogarithmisch/2;}
